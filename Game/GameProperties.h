...
{
const float _playerVerticalSpeed = 60*60;
const float _playerHorizontalSpeed = 900.f;

const float _iceBlockSpeed = 600.f;
};
...
const float Ice_block_width = 100.f;
const float Ice_block_height = 30.f;
...
const float safe_zone_height = 50.0f;
...
const int ice_blocks_Y = 242;

const float _playerOriginalPositionX = ScreenDimensions::_Screen_Width - playerWidth;
const float _playerOriginalPositionY = 150;

const float _safeOriginalPositionX = 4*safe_zone_height;
const float _safeOriginalPositionY = 4*safe_zone_height;
